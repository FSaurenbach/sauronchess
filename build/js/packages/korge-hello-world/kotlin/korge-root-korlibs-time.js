(function (root, factory) {
  ...
  var abs = kotlin_kotlin.$_$.hg;
  var _Char___init__impl__6a9atx = kotlin_kotlin.$_$.k3;
  var padStart = kotlin_kotlin.$_$.pi;
  ...
  var DurationUnit_MINUTES_getInstance = kotlin_kotlin.$_$.o;
  ...
  var DurationUnit_MILLISECONDS_getInstance = kotlin_kotlin.$_$.n;
  ...
  var DurationUnit_DAYS_getInstance = kotlin_kotlin.$_$.k;
  var Duration__unaryMinus_impl_x2k1y0 = kotlin_kotlin.$_$.i3;
  ...
  var take = kotlin_kotlin.$_$.hj;
  var drop_0 = kotlin_kotlin.$_$.wh;
  var first = kotlin_kotlin.$_$.ci;
  ...
  var _Duration___get_inWholeNanoseconds__impl__r5x4mr = kotlin_kotlin.$_$.b3;
  var toDuration_0 = kotlin_kotlin.$_$.ik;
  var _Duration___get_inWholeMicroseconds__impl__8oe8vv = kotlin_kotlin.$_$.z2;
  ...
  setMetadataFor(Date_0, 'Date', classMeta, VOID, [Comparable, Serializable]);
  setMetadataFor(DateException, 'DateException', classMeta, RuntimeException);
  ...
  setMetadataFor(DateFormat, 'DateFormat', interfaceMeta);
  setMetadataFor(DatePart, 'DatePart', classMeta, Enum);
  setMetadataFor(Companion_1, 'Companion', objectMeta);
  setMetadataFor(DateTime, 'DateTime', classMeta, VOID, [Comparable, Serializable]);
  setMetadataFor(Companion_2, 'Companion', objectMeta);
  setMetadataFor(Companion_3, 'Companion', objectMeta);
  setMetadataFor(ComputedTime, 'ComputedTime', classMeta);
  setMetadataFor(DateTimeSpan, 'DateTimeSpan', classMeta, VOID, [Comparable, Serializable], DateTimeSpan_init_$Create$);
  setMetadataFor(Companion_4, 'Companion', objectMeta);
  setMetadataFor(DateTimeTz, 'DateTimeTz', classMeta, VOID, [Comparable, Serializable]);
  setMetadataFor(Companion_5, 'Companion', objectMeta);
  setMetadataFor(DayOfWeek, 'DayOfWeek', classMeta, Enum, [Enum, Serializable]);
  setMetadataFor(DayOfWeekWithLocale, 'DayOfWeekWithLocale', classMeta, VOID, [Comparable]);
  setMetadataFor(Companion_6, 'Companion', objectMeta);
  setMetadataFor(Frequency, 'Frequency', classMeta, VOID, [Comparable, Serializable]);
  setMetadataFor(KlockLocale, 'KlockLocale', classMeta);
  setMetadataFor(English, 'English', classMeta, KlockLocale, VOID, English);
  setMetadataFor(Companion_7, 'Companion', objectMeta, English);
  setMetadataFor(Companion_8, 'Companion', objectMeta);
  setMetadataFor(sam$kotlin_Comparator$0, 'sam$kotlin_Comparator$0', classMeta, VOID, [Comparator]);
  setMetadataFor(Companion_9, 'Companion', objectMeta);
  setMetadataFor(KlockLocaleContext, 'KlockLocaleContext', classMeta, VOID, VOID, KlockLocaleContext);
  setMetadataFor(KlockLocaleGender, 'KlockLocaleGender', classMeta, Enum);
  setMetadataFor(TimedResult, 'TimedResult', classMeta);
  setMetadataFor(Companion_10, 'Companion', objectMeta);
  setMetadataFor(Month, 'Month', classMeta, Enum, [Enum, Serializable]);
  setMetadataFor(Companion_11, 'Companion', objectMeta);
  setMetadataFor(MonthSpan, 'MonthSpan', classMeta, VOID, [Comparable, Serializable]);
  setMetadataFor(Companion_12, 'Companion', objectMeta);
  setMetadataFor(NumberOfTimes, 'NumberOfTimes', classMeta);
  setMetadataFor(Companion_13, 'Companion', objectMeta);
  setMetadataFor(Companion_14, 'Companion', objectMeta);
  setMetadataFor(Options, 'Options', classMeta, VOID, [Serializable], Options);
  setMetadataFor(PatternDateFormat, 'PatternDateFormat', classMeta, VOID, [DateFormat, Serializable]);
  setMetadataFor(Companion_15, 'Companion', objectMeta);
  setMetadataFor(Companion_16, 'Companion', objectMeta);
  setMetadataFor(Options_0, 'Options', classMeta, VOID, [Serializable], Options_0);
  ...
  setMetadataFor(TimeFormat, 'TimeFormat', interfaceMeta);
  setMetadataFor(PatternTimeFormat, 'PatternTimeFormat', classMeta, VOID, [TimeFormat, Serializable]);
  setMetadataFor(PerformanceCounter, 'PerformanceCounter', objectMeta);
  setMetadataFor(Stopwatch, 'Stopwatch', classMeta, VOID, VOID, Stopwatch);
  setMetadataFor(Companion_17, 'Companion', objectMeta);
  setMetadataFor(Time, 'Time', classMeta, VOID, [Comparable, Serializable]);
  setMetadataFor(Companion_18, 'Companion', objectMeta);
  setMetadataFor(TimeProvider, 'TimeProvider', interfaceMeta);
  setMetadataFor(TimeProvider$Companion$invoke$1, VOID, classMeta, VOID, [TimeProvider]);
  setMetadataFor(Companion_19, 'Companion', objectMeta, VOID, [TimeProvider]);
  setMetadataFor(IntTimedCache, 'IntTimedCache', classMeta);
  setMetadataFor(Timezone, 'Timezone', classMeta, Enum);
  setMetadataFor(Companion_20, 'Companion', objectMeta);
  setMetadataFor(TimezoneNames, 'TimezoneNames', classMeta, VOID, [Serializable]);
  setMetadataFor(Companion_21, 'Companion', objectMeta);
  setMetadataFor(TimezoneOffset, 'TimezoneOffset', classMeta, VOID, [Comparable, Serializable]);
  setMetadataFor(Companion_22, 'Companion', objectMeta);
  setMetadataFor(Year, 'Year', classMeta, VOID, [Comparable, Serializable]);
  setMetadataFor(Companion_23, 'Companion', objectMeta);
  setMetadataFor(YearMonth, 'YearMonth', classMeta, VOID, [Serializable]);
  setMetadataFor(MicroStrReader, 'MicroStrReader', classMeta);
  setMetadataFor(Moduler, 'Moduler', classMeta);
  ...
  protoOf(Companion).invoke_c15hzb_k$ = function (year, month, day) {
    return Companion_getInstance_1().invoke_b5nqkb_k$(year, month.get_index1_etpsq0_k$(), day);
  };
  protoOf(Companion).invoke_s66luw_k$ = function (year, month, day) {
  ...
  function _Date___get_month__impl__def9fs($this) {
    return Companion_getInstance_12().get_c1px32_k$(_Date___get_month1__impl__tkbnv($this));
  }
  ...
  function _Date___get_dateTimeDayStart__impl__u9j4lh($this) {
    return Companion_getInstance_3().invoke$default_hbvks4_k$(_Date___get_year__impl__gvb68n($this), _Date___get_month__impl__def9fs($this), _Date___get_day__impl__v4952c($this));
  }
  ...
  function parse(_this__u8e3s4, str, doAdjust) {
    ...
    if (tmp0_elvis_lhs == null) {
      throw new DateException("Not a valid format: '" + str + "' for '" + _this__u8e3s4 + "'");
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
  ...
  function timeToMillisUnchecked($this, hour, minute, second) {
    return hour * get_MILLIS_PER_HOUR() + minute * get_MILLIS_PER_MINUTE() + second * get_MILLIS_PER_SECOND();
  }
  function dateToMillis($this, year, month, day) {
    Companion_getInstance_12().checked_99ekhb_k$(month);
    if (!(1 <= day ? day <= Companion_getInstance_12().invoke_dlyhwg_k$(month).days_101u5b_k$(year) : false))
      throw new DateException('Day ' + day + ' not valid for year=' + year + ' and month=' + month);
    return $this.dateToMillisUnchecked_294mfb_k$(year, month, day);
  }
  ...
  protoOf(Companion_1).invoke_mg9zr9_k$ = function (year, month, day, hour, minute, second, milliseconds) {
  ...
  protoOf(Companion_1).invoke$default_mqkz81_k$ = function (year, month, day, hour, minute, second, milliseconds, $super) {
    hour = hour === VOID ? 0 : hour;
    minute = minute === VOID ? 0 : minute;
    second = second === VOID ? 0 : second;
    milliseconds = milliseconds === VOID ? 0 : milliseconds;
    return $super === VOID ? this.invoke_mg9zr9_k$(year, month, day, hour, minute, second, milliseconds) : $super.invoke_mg9zr9_k$.call(this, new Year(year), month, day, hour, minute, second, milliseconds).unixMillis_1;
  };
  ...
  protoOf(Companion_1).invoke_ua6fxi_k$ = function (year, month, day, hour, minute, second, milliseconds) {
  ...
  protoOf(Companion_1).invoke$default_hbvks4_k$ = function (year, month, day, hour, minute, second, milliseconds, $super) {
    hour = hour === VOID ? 0 : hour;
    minute = minute === VOID ? 0 : minute;
    second = second === VOID ? 0 : second;
    milliseconds = milliseconds === VOID ? 0 : milliseconds;
    return $super === VOID ? this.invoke_ua6fxi_k$(year, month, day, hour, minute, second, milliseconds) : $super.invoke_ua6fxi_k$.call(this, year, month, day, hour, minute, second, milliseconds).unixMillis_1;
  };
  ...
  protoOf(Companion_1).createClamped_ejfxjy_k$ = function (year, month, day, hour, minute, second, milliseconds) {
    ...
    return this.createUnchecked_bq02a6_k$(year, clampedMonth, coerceIn(day, 1, Companion_getInstance_12().invoke_dlyhwg_k$(month).days_101u5b_k$(year)), coerceIn(hour, 0, 23), coerceIn(minute, 0, 59), coerceIn(second, 0, 59), milliseconds);
  };
  ...
  protoOf(Companion_1).createAdjusted_m79lxy_k$ = function (year, month, day, hour, minute, second, milliseconds) {
    ...
    th = cycle(th, 0, 23);
    $l$loop: while (true) {
      var dup = Companion_getInstance_12().invoke_dlyhwg_k$(dm).days_101u5b_k$(dy);
      dm = dm + cycleSteps(dd, 1, dup) | 0;
      dd = cycle(dd, 1, dup);
      dy = dy + cycleSteps(dm, 1, 12) | 0;
      dm = cycle(dm, 1, 12);
      if (cycle(dd, 1, Companion_getInstance_12().invoke_dlyhwg_k$(dm).days_101u5b_k$(dy)) === dd) {
        break $l$loop;
      }
    }
  ...
  protoOf(Companion_1).createUnchecked_bq02a6_k$ = function (year, month, day, hour, minute, second, milliseconds) {
    return _DateTime___init__impl__ifgty2(Companion_getInstance_3().dateToMillisUnchecked_294mfb_k$(year, month, day) + timeToMillisUnchecked(Companion_getInstance_3(), hour, minute, second) + milliseconds);
  };
  ...
  protoOf(Companion_1).get_EPOCH_INTERNAL_MILLIS_fel4vr_k$ = function () {
    return this.EPOCH_INTERNAL_MILLIS_1;
  };
  protoOf(Companion_1).dateToMillisUnchecked_294mfb_k$ = function (year, month, day) {
    return (((_Year___get_daysSinceOne__impl__cf4kem(_Year___init__impl__2jvef0(year)) + Companion_getInstance_12().invoke_dlyhwg_k$(month).daysToStart_x9v8c8_k$(year) | 0) + day | 0) - 1 | 0) * get_MILLIS_PER_DAY() - 6.21355968E13;
  };
  protoOf(Companion_1).getDatePart_70wszh_k$ = function (millis, part) {
    var totalDays = toInt2(millis / get_MILLIS_PER_DAY());
    var year = Companion_getInstance_24().fromDays_egwdof_k$(totalDays);
    ...
    if (part.equals(DatePart_DayOfYear_getInstance()))
      return dayOfYear;
    var tmp0_elvis_lhs = Companion_getInstance_12().fromDayOfYear_p5oq19_k$(dayOfYear, isLeap);
    var tmp;
    if (tmp0_elvis_lhs == null) {
  ...
  function _DateTime___get_localOffset__impl__qgw4hf($this) {
    return Companion_getInstance_23().local_qfhv1l_k$(_DateTime___init__impl__ifgty2(_DateTime___get_unixMillisDouble__impl__3dzlsc($this)));
  }
  ...
  function _DateTime___get_yearInt__impl__876eh3($this) {
    return Companion_getInstance_3().getDatePart_70wszh_k$(_DateTime___get_yearOneMillis__impl__jjnslg($this), DatePart_Year_getInstance());
  }
  function _DateTime___get_month__impl__4rr4id($this) {
    return Companion_getInstance_12().get_c1px32_k$(_DateTime___get_month1__impl__hf8ase($this));
  }
  ...
  function _DateTime___get_month1__impl__hf8ase($this) {
    return Companion_getInstance_3().getDatePart_70wszh_k$(_DateTime___get_yearOneMillis__impl__jjnslg($this), DatePart_Month_getInstance());
  }
  function _DateTime___get_yearMonth__impl__3rw9mg($this) {
    return Companion_getInstance_25().invoke_de7zdx_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this));
  }
  function _DateTime___get_dayOfMonth__impl__z5062($this) {
    return Companion_getInstance_3().getDatePart_70wszh_k$(_DateTime___get_yearOneMillis__impl__jjnslg($this), DatePart_Day_getInstance());
  }
  ...
  function _DateTime___get_dayOfWeekInt__impl__yrgob9($this) {
    return toIntMod(_DateTime___get_yearOneMillis__impl__jjnslg($this) / get_MILLIS_PER_DAY() + 1, 7);
  }
  function _DateTime___get_dayOfYear__impl__1v0nln($this) {
    return Companion_getInstance_3().getDatePart_70wszh_k$(_DateTime___get_yearOneMillis__impl__jjnslg($this), DatePart_DayOfYear_getInstance());
  }
  function _DateTime___get_hours__impl__gihczo($this) {
    return toIntMod(_DateTime___get_yearOneMillis__impl__jjnslg($this) / get_MILLIS_PER_HOUR(), 24);
  }
  function _DateTime___get_minutes__impl__ua9590($this) {
    return toIntMod(_DateTime___get_yearOneMillis__impl__jjnslg($this) / get_MILLIS_PER_MINUTE(), 60);
  }
  function _DateTime___get_seconds__impl__145pqk($this) {
    return toIntMod(_DateTime___get_yearOneMillis__impl__jjnslg($this) / get_MILLIS_PER_SECOND(), 60);
  }
  ...
  function _DateTime___get_dateDayStart__impl__hfd2rl($this) {
    return Companion_getInstance_3().invoke_mg9zr9_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), _DateTime___get_dayOfMonth__impl__z5062($this), 0, 0, 0, 0);
  }
  function _DateTime___get_dateDayEnd__impl__bbd3ty($this) {
    return Companion_getInstance_3().invoke_mg9zr9_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), _DateTime___get_dayOfMonth__impl__z5062($this), 23, 59, 59, 999);
  }
  ...
  function _DateTime___get_startOfYear__impl__er9m6j($this) {
    return Companion_getInstance_3().invoke$default_mqkz81_k$(_DateTime___get_year__impl__mczyhi($this), Month_January_getInstance(), 1);
  }
  function _DateTime___get_startOfMonth__impl__iy71lg($this) {
    return Companion_getInstance_3().invoke$default_mqkz81_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), 1);
  }
  function _DateTime___get_startOfQuarter__impl__6dsqm8($this) {
    return Companion_getInstance_3().invoke$default_mqkz81_k$(_DateTime___get_year__impl__mczyhi($this), Companion_getInstance_12().get_c1px32_k$(imul(_DateTime___get_quarter__impl__ich2kh($this) - 1 | 0, 3) + 1 | 0), 1);
  }
  ...
  function _DateTime___get_startOfDay__impl__srba5s($this) {
    return Companion_getInstance_3().invoke$default_mqkz81_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), _DateTime___get_dayOfMonth__impl__z5062($this));
  }
  function _DateTime___get_startOfHour__impl__26bram($this) {
    return Companion_getInstance_3().invoke$default_mqkz81_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), _DateTime___get_dayOfMonth__impl__z5062($this), _DateTime___get_hours__impl__gihczo($this));
  }
  function _DateTime___get_startOfMinute__impl__rs1zi6($this) {
    return Companion_getInstance_3().invoke$default_mqkz81_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), _DateTime___get_dayOfMonth__impl__z5062($this), _DateTime___get_hours__impl__gihczo($this), _DateTime___get_minutes__impl__ua9590($this));
  }
  function _DateTime___get_startOfSecond__impl__a5rmn6($this) {
    return Companion_getInstance_3().invoke$default_mqkz81_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), _DateTime___get_dayOfMonth__impl__z5062($this), _DateTime___get_hours__impl__gihczo($this), _DateTime___get_minutes__impl__ua9590($this), _DateTime___get_seconds__impl__145pqk($this));
  }
  function _DateTime___get_endOfYear__impl__43jzac($this) {
    return Companion_getInstance_3().invoke_mg9zr9_k$(_DateTime___get_year__impl__mczyhi($this), Month_December_getInstance(), 31, 23, 59, 59, 999);
  }
  function _DateTime___get_endOfMonth__impl__rcfg85($this) {
    return Companion_getInstance_3().invoke_mg9zr9_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), _DateTime___get_month__impl__4rr4id($this).days_eg9z5s_k$(_DateTime___get_year__impl__mczyhi($this)), 23, 59, 59, 999);
  }
  function _DateTime___get_endOfQuarter__impl__hw6njt($this) {
    return Companion_getInstance_3().invoke_mg9zr9_k$(_DateTime___get_year__impl__mczyhi($this), Companion_getInstance_12().get_c1px32_k$(imul(_DateTime___get_quarter__impl__ich2kh($this) - 1 | 0, 3) + 3 | 0), _DateTime___get_month__impl__4rr4id($this).days_eg9z5s_k$(_DateTime___get_year__impl__mczyhi($this)), 23, 59, 59, 999);
  }
  ...
  function _DateTime___get_endOfHour__impl__cu1e6t($this) {
    return Companion_getInstance_3().invoke_mg9zr9_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), _DateTime___get_dayOfMonth__impl__z5062($this), _DateTime___get_hours__impl__gihczo($this), 59, 59, 999);
  }
  function _DateTime___get_endOfMinute__impl__spxti3($this) {
    return Companion_getInstance_3().invoke_mg9zr9_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), _DateTime___get_dayOfMonth__impl__z5062($this), _DateTime___get_hours__impl__gihczo($this), _DateTime___get_minutes__impl__ua9590($this), 59, 999);
  }
  function _DateTime___get_endOfSecond__impl__4dcmbp($this) {
    return Companion_getInstance_3().invoke_mg9zr9_k$(_DateTime___get_year__impl__mczyhi($this), _DateTime___get_month__impl__4rr4id($this), _DateTime___get_dayOfMonth__impl__z5062($this), _DateTime___get_hours__impl__gihczo($this), _DateTime___get_minutes__impl__ua9590($this), _DateTime___get_seconds__impl__145pqk($this), 999);
  }
  ...
  function _DateTime___get_time__impl__779dfe($this) {
    return Companion_getInstance_19().invoke_pdi41e_k$(_DateTime___get_hours__impl__gihczo($this), _DateTime___get_minutes__impl__ua9590($this), _DateTime___get_seconds__impl__145pqk($this), _DateTime___get_milliseconds__impl__xmznxd($this));
  }
  ...
  function DateTime__add_impl_fzlt95($this, deltaMonths, deltaMilliseconds) {
    ...
    if (deltaMonths === 0 ? deltaMilliseconds === 0.0 : false) {
      ...
      if (i >= 0) {
        month = (i % Companion_getInstance_12().get_Count_i890hy_k$() | 0) + 1 | 0;
        year = Year__plus_impl_l5v1ey(year, i / Companion_getInstance_12().get_Count_i890hy_k$() | 0);
      } else {
        month = Companion_getInstance_12().get_Count_i890hy_k$() + ((i + 1 | 0) % Companion_getInstance_12().get_Count_i890hy_k$() | 0) | 0;
        year = Year__plus_impl_l5v1ey(year, (i - (Companion_getInstance_12().get_Count_i890hy_k$() - 1 | 0) | 0) / Companion_getInstance_12().get_Count_i890hy_k$() | 0);
      }
      var days = Companion_getInstance_12().invoke_dlyhwg_k$(month).days_eg9z5s_k$(year);
      if (day > days)
        day = days;
      tmp = _DateTime___init__impl__ifgty2(Companion_getInstance_3().dateToMillisUnchecked_294mfb_k$(_Year___get_year__impl__hjar94(year), month, day) + _DateTime___get_yearOneMillis__impl__jjnslg($this) % get_MILLIS_PER_DAY() + deltaMilliseconds);
    }
    return tmp;
  }
  ...
  function DateTime__copyDayOfMonth_impl_ti7cfk($this, year, month, dayOfMonth, hours, minutes, seconds, milliseconds) {
    return Companion_getInstance_3().invoke_mg9zr9_k$(year, month, dayOfMonth, hours, minutes, seconds, milliseconds);
  }
  function DateTime__copyDayOfMonth$default_impl_apy88d($this, year, month, dayOfMonth, hours, minutes, seconds, milliseconds, $super) {
    ...
    if ($super === VOID) {
      ...
      var tmp_0 = $super;
      tmp = (tmp_0 == null ? null : new DateTime(tmp_0)).copyDayOfMonth_ionp51_k$.call(new DateTime($this), new Year(year), month, dayOfMonth, hours, minutes, seconds, milliseconds).unixMillis_1;
    }
    return tmp;
  }
  ...
  protoOf(Companion_2).invoke_71s1sd_k$ = function (time) {
    ...
    var weeks = $this$run.int_hxmlc9_k$(get_MILLIS_PER_WEEK());
    var days = $this$run.int_hxmlc9_k$(get_MILLIS_PER_DAY());
    var hours = $this$run.int_hxmlc9_k$(get_MILLIS_PER_HOUR());
    var minutes = $this$run.int_hxmlc9_k$(get_MILLIS_PER_MINUTE());
    var seconds = $this$run.int_hxmlc9_k$(get_MILLIS_PER_SECOND());
  ...
  protoOf(DateTimeSpan).get_daysIncludingWeeks_dtup2_k$ = function () {
    return _get_computed__1g6kpq(this).days_1 + imul(_get_computed__1g6kpq(this).weeks_1, Companion_getInstance_7().get_Count_i890hy_k$()) | 0;
  };
  ...
  protoOf(DateTimeSpan).get_secondsIncludingMilliseconds_luy40v_k$ = function () {
    return _get_computed__1g6kpq(this).seconds_1 + _get_computed__1g6kpq(this).milliseconds_1 / get_MILLIS_PER_SECOND();
  };
  ...
  protoOf(Companion_4).fromUnix_3nprtw_k$ = function (unix) {
    ...
    return this.utc_dlfehc_k$(unixDateTime, Companion_getInstance_23().local_qfhv1l_k$(unixDateTime));
  };
  ...
  protoOf(DateTimeTz).toString = function () {
    return 'DateTimeTz(' + new DateTime(this.adjusted_1) + ', ' + new TimezoneOffset(this.offset_1) + ')';
  };
  ...
  protoOf(Companion_5).get0$default_2zcty6_k$ = function (index0, locale, $super) {
    locale = locale === VOID ? Companion_getInstance_10().get_default_qtagd4_k$() : locale;
  ...
  protoOf(DayOfWeek).isWeekend_net2kg_k$ = function (locale) {
    return locale.isWeekend_jrdsrt_k$(this);
  };
  protoOf(DayOfWeek).isWeekend$default_f0w8dj_k$ = function (locale, $super) {
    locale = locale === VOID ? Companion_getInstance_10().get_default_qtagd4_k$() : locale;
  ...
  protoOf(DayOfWeek).get_localName_bf4zrn_k$ = function () {
    return this.localName_ietoqh_k$(Companion_getInstance_10().get_default_qtagd4_k$());
  };
  ...
  protoOf(DayOfWeek).get_localShortName_r1vbp7_k$ = function () {
    return this.localShortName_mk3rof_k$(Companion_getInstance_10().get_default_qtagd4_k$());
  };
  ...
  protoOf(DayOfWeek).prev$default_3ac57y_k$ = function (offset, $super) {
  ...
  protoOf(DayOfWeek).next$default_io0q1e_k$ = function (offset, $super) {
    offset = offset === VOID ? 1 : offset;
  ...
  protoOf(DayOfWeekWithLocale).copy_1ss9hu_k$ = function (dayOfWeek, locale) {
    return new DayOfWeekWithLocale(dayOfWeek, locale);
  };
  protoOf(DayOfWeekWithLocale).copy$default_i6cjrz_k$ = function (dayOfWeek, locale, $super) {
    dayOfWeek = dayOfWeek === VOID ? this.dayOfWeek_1 : dayOfWeek;
    locale = locale === VOID ? this.locale_1 : locale;
    return $super === VOID ? this.copy_1ss9hu_k$(dayOfWeek, locale) : $super.copy_1ss9hu_k$.call(this, dayOfWeek, locale);
  };
  protoOf(DayOfWeekWithLocale).toString = function () {
    return 'DayOfWeekWithLocale(dayOfWeek=' + this.dayOfWeek_1 + ', locale=' + this.locale_1 + ')';
  };
  ...
  protoOf(Companion_6).from_u1ej3g_k$ = function (timeSpan) {
  ...
  function Frequency__compareTo_impl_t74mdz($this, other) {
    return compareTo(_Frequency___get_hertz__impl__9m7k6x($this), _Frequency___get_hertz__impl__9m7k6x(other));
  }
  function Frequency__compareTo_impl_t74mdz_0($this, other) {
    return Frequency__compareTo_impl_t74mdz($this.hertz_1, other instanceof Frequency ? other.hertz_1 : THROW_CCE());
  }
  function Frequency__unaryMinus_impl_fa2mr4($this) {
    return _Frequency___init__impl__upasnx(-_Frequency___get_hertz__impl__9m7k6x($this));
  }
  function Frequency__unaryPlus_impl_guzuhs($this) {
    return $this;
  }
  function Frequency__plus_impl_77w1qv($this, other) {
    return _Frequency___init__impl__upasnx(_Frequency___get_hertz__impl__9m7k6x($this) + _Frequency___get_hertz__impl__9m7k6x(other));
  }
  function Frequency__minus_impl_u1w613($this, other) {
    return _Frequency___init__impl__upasnx(_Frequency___get_hertz__impl__9m7k6x($this) - _Frequency___get_hertz__impl__9m7k6x(other));
  }
  function Frequency__times_impl_wceqal($this, scale) {
    return _Frequency___init__impl__upasnx(_Frequency___get_hertz__impl__9m7k6x($this) * scale);
  }
  function Frequency__times_impl_wceqal_0($this, scale) {
    return _Frequency___init__impl__upasnx(_Frequency___get_hertz__impl__9m7k6x($this) * scale);
  }
  function Frequency__times_impl_wceqal_1($this, scale) {
    return _Frequency___init__impl__upasnx(_Frequency___get_hertz__impl__9m7k6x($this) * scale);
  }
  function Frequency__div_impl_5arvuw($this, scale) {
    return _Frequency___init__impl__upasnx(_Frequency___get_hertz__impl__9m7k6x($this) / scale);
  }
  function Frequency__div_impl_5arvuw_0($this, scale) {
    return _Frequency___init__impl__upasnx(_Frequency___get_hertz__impl__9m7k6x($this) / scale);
  }
  function Frequency__div_impl_5arvuw_1($this, scale) {
    return _Frequency___init__impl__upasnx(_Frequency___get_hertz__impl__9m7k6x($this) / scale);
  }
  function Frequency__rem_impl_jwl9bl($this, other) {
    return _Frequency___init__impl__upasnx(_Frequency___get_hertz__impl__9m7k6x($this) % _Frequency___get_hertz__impl__9m7k6x(other));
  }
  function Frequency__umod_impl_4i8jj8($this, other) {
    return _Frequency___init__impl__upasnx(umod_0(_Frequency___get_hertz__impl__9m7k6x($this), _Frequency___get_hertz__impl__9m7k6x(other)));
  }
  ...
  function Frequency__toString_impl_wr1vet($this) {
    return 'Frequency(hertz=' + $this + ')';
  }
  function Frequency__hashCode_impl_azvyly($this) {
    return getNumberHashCode($this);
  }
  function Frequency__equals_impl_dfatri($this, other) {
    if (!(other instanceof Frequency))
      return false;
    var tmp0_other_with_cast = other instanceof Frequency ? other.hertz_1 : THROW_CCE();
    if (!equals($this, tmp0_other_with_cast))
      return false;
    return true;
  }
  ...
  protoOf(Frequency).compareTo_pbe1gf_k$ = function (other) {
    return Frequency__compareTo_impl_t74mdz(this.hertz_1, other);
  };
  protoOf(Frequency).compareTo_hpufkf_k$ = function (other) {
    return Frequency__compareTo_impl_t74mdz_0(this, other);
  };
  protoOf(Frequency).toString = function () {
    return Frequency__toString_impl_wr1vet(this.hertz_1);
  };
  protoOf(Frequency).hashCode = function () {
    return Frequency__hashCode_impl_azvyly(this.hertz_1);
  };
  protoOf(Frequency).equals = function (other) {
    return Frequency__equals_impl_dfatri(this.hertz_1, other);
  };
  function toFrequency(_this__u8e3s4) {
    return get_timesPerSecond(_this__u8e3s4);
  }
  function get_timesPerSecond(_this__u8e3s4) {
    return _Frequency___init__impl__upasnx(1.0 / get_seconds_1(_this__u8e3s4));
  }
  ...
  protoOf(Companion_8).get_english_p9a54p_k$ = function () {
    return Companion_getInstance_9();
  };
  protoOf(Companion_8).set_default_hznpu1_k$ = function (value) {
    KlockLocale_default = value;
  };
  protoOf(Companion_8).get_default_qtagd4_k$ = function () {
    var tmp0_elvis_lhs = KlockLocale_default;
    return tmp0_elvis_lhs == null ? Companion_getInstance_9() : tmp0_elvis_lhs;
  };
  protoOf(Companion_8).setTemporarily_8f9cmr_k$ = function (locale, callback) {
  ...
  protoOf(KlockLocale).localizedDayOfWeek_ljhyxm_k$ = function (dayOfWeek) {
  ...
  protoOf(KlockLocale).getOrdinalByDay$default_hl9obs_k$ = function (day, context, $super) {
    context = context === VOID ? Companion_getInstance_11().get_Default_goqax4_k$() : context;
  ...
  protoOf(KlockLocale).isWeekend_jrdsrt_k$ = function (dayOfWeek) {
  ...
  protoOf(Companion_9).get_Default_goqax4_k$ = function () {
  ...
  protoOf(KlockLocaleContext).toString = function () {
    return 'KlockLocaleContext(gender=' + this.gender_1 + ')';
  };
  ...
  protoOf(TimedResult).get_result_iyg5d2_k$ = function () {
    return this.result_1;
  };
  protoOf(TimedResult).get_time_w99fmc_k$ = function () {
    return this.time_1;
  };
  protoOf(TimedResult).component1_7eebsc_k$ = function () {
    return this.result_1;
  };
  protoOf(TimedResult).component2_pa7z4b_k$ = function () {
    return this.time_1;
  };
  protoOf(TimedResult).copy_m9wxlr_k$ = function (result, time) {
    return new TimedResult(result, time);
  };
  protoOf(TimedResult).copy$default_b76qby_k$ = function (result, time, $super) {
    result = result === VOID ? this.result_1 : result;
    time = time === VOID ? this.time_1 : time;
    return $super === VOID ? this.copy_m9wxlr_k$(result, time) : $super.copy_m9wxlr_k$.call(this, result, new Duration(time));
  };
  protoOf(TimedResult).toString = function () {
    return 'TimedResult(result=' + this.result_1 + ', time=' + new Duration(this.time_1) + ')';
  };
  protoOf(TimedResult).hashCode = function () {
    var result = this.result_1 == null ? 0 : hashCode(this.result_1);
    result = imul(result, 31) + Duration__hashCode_impl_u4exz6(this.time_1) | 0;
    return result;
  };
  ...
  function measureTimeWithResult(callback) {
    var start = PerformanceCounter_getInstance().get_microseconds_sscqkk_k$();
    var result = callback();
    var end = PerformanceCounter_getInstance().get_microseconds_sscqkk_k$();
    // Inline function 'korlibs.time.microseconds' call
    var this_0 = end - start;
    var elapsed = toDuration(this_0, DurationUnit_MICROSECONDS_getInstance());
  ...
  function measureTime(callback) {
    ...
    // Inline function 'korlibs.time.microseconds' call
    var this_0 = end - start;
    return toDuration(this_0, DurationUnit_MICROSECONDS_getInstance());
  }
  ...
  function generateDaysToStart($this, leap) {
    ...
    while (tmp < 13) {
      var tmp_1 = tmp;
      total = total + (tmp_1 === 0 ? 0 : Companion_getInstance_12().BY_INDEX0__1[tmp_1 - 1 | 0].days_tlk1ta_k$(leap)) | 0;
      tmp_0[tmp_1] = total;
      tmp = tmp + 1 | 0;
    }
    return tmp_0;
  ...
  protoOf(Companion_10).get_Count_i890hy_k$ = function () {
    return this.Count_1;
  };
  protoOf(Companion_10).invoke_dlyhwg_k$ = function (index1) {
    return this.adjusted_urrcuu_k$(index1);
  };
  protoOf(Companion_10).get_c1px32_k$ = function (index1) {
    return this.adjusted_urrcuu_k$(index1);
  };
  protoOf(Companion_10).adjusted_urrcuu_k$ = function (index1) {
    return this.BY_INDEX0__1[umod(index1 - 1 | 0, 12)];
  };
  protoOf(Companion_10).checked_99ekhb_k$ = function (index1) {
  ...
  protoOf(Companion_10).fromDayOfYear_p5oq19_k$ = function (dayOfYear, leap) {
    ...
    if (tmp)
      return Companion_getInstance_12().get_c1px32_k$(guess + 1 | 0);
    var tmp_0;
    ...
    if (tmp_0)
      return Companion_getInstance_12().get_c1px32_k$(guess + 2 | 0);
    return null;
  };
  protoOf(Companion_10).fromDayOfYear_expb6j_k$ = function (dayOfYear, year) {
  ...
  protoOf(Month).daysToStart_kxj591_k$ = function (leap) {
    return YEAR_DAYS(Companion_getInstance_12(), leap)[this.get_index0_etpspz_k$()];
  };
  ...
  protoOf(Month).daysToEnd_sjlksc_k$ = function (leap) {
    return YEAR_DAYS(Companion_getInstance_12(), leap)[this.index1__1];
  };
  ...
  protoOf(Month).plus_gv6ohq_k$ = function (delta) {
    return Companion_getInstance_12().get_c1px32_k$(this.index1__1 + delta | 0);
  };
  protoOf(Month).minus_vfk7ag_k$ = function (delta) {
    return Companion_getInstance_12().get_c1px32_k$(this.index1__1 - delta | 0);
  };
  protoOf(Month).minus_ocjvey_k$ = function (other) {
  ...
  function _NumberOfTimes___init__impl__a2ga4z(count) {
    return count;
  }
  function _NumberOfTimes___get_count__impl__t6j31z($this) {
    return $this;
  }
  function Companion_12() {
    Companion_instance_12 = this;
    this.ZERO_1 = _NumberOfTimes___init__impl__a2ga4z(0);
    this.ONE_1 = _NumberOfTimes___init__impl__a2ga4z(1);
    this.INFINITE_1 = _NumberOfTimes___init__impl__a2ga4z(IntCompanionObject_getInstance().get_MIN_VALUE_7nmmor_k$());
  }
  protoOf(Companion_12).get_ZERO_gwb7rc_k$ = function () {
    return this.ZERO_1;
  };
  protoOf(Companion_12).get_ONE_qzmick_k$ = function () {
    return this.ONE_1;
  };
  protoOf(Companion_12).get_INFINITE_txc1i4_k$ = function () {
  ...
  function _NumberOfTimes___get_isInfinite__impl__yu5b4o($this) {
    return $this === Companion_getInstance_14().INFINITE_1;
  }
  function _NumberOfTimes___get_isFinite__impl__pm18wj($this) {
    return !_NumberOfTimes___get_isInfinite__impl__yu5b4o($this);
  }
  function _NumberOfTimes___get_hasMore__impl__4nza89($this) {
    return !($this === Companion_getInstance_14().ZERO_1);
  }
  function _NumberOfTimes___get_oneLess__impl__4w72bd($this) {
    return $this === Companion_getInstance_14().INFINITE_1 ? Companion_getInstance_14().INFINITE_1 : _NumberOfTimes___init__impl__a2ga4z(_NumberOfTimes___get_count__impl__t6j31z($this) - 1 | 0);
  }
  function NumberOfTimes__plus_impl_kit3jn($this, other) {
    return ($this === Companion_getInstance_14().INFINITE_1 ? true : other === Companion_getInstance_14().INFINITE_1) ? Companion_getInstance_14().INFINITE_1 : _NumberOfTimes___init__impl__a2ga4z(_NumberOfTimes___get_count__impl__t6j31z($this) + _NumberOfTimes___get_count__impl__t6j31z(other) | 0);
  }
  function NumberOfTimes__minus_impl_xcwzlv($this, other) {
    return $this === other ? Companion_getInstance_14().ZERO_1 : ($this === Companion_getInstance_14().INFINITE_1 ? true : other === Companion_getInstance_14().INFINITE_1) ? Companion_getInstance_14().INFINITE_1 : _NumberOfTimes___init__impl__a2ga4z(_NumberOfTimes___get_count__impl__t6j31z($this) - _NumberOfTimes___get_count__impl__t6j31z(other) | 0);
  }
  function NumberOfTimes__times_impl_v2efcd($this, other) {
    return $this === Companion_getInstance_14().INFINITE_1 ? Companion_getInstance_14().INFINITE_1 : _NumberOfTimes___init__impl__a2ga4z(imul(_NumberOfTimes___get_count__impl__t6j31z($this), other));
  }
  function NumberOfTimes__div_impl_66znwe($this, other) {
    return $this === Companion_getInstance_14().INFINITE_1 ? Companion_getInstance_14().INFINITE_1 : _NumberOfTimes___init__impl__a2ga4z(_NumberOfTimes___get_count__impl__t6j31z($this) / other | 0);
  }
  function NumberOfTimes__toString_impl_gmpdqd($this) {
    return $this === Companion_getInstance_14().INFINITE_1 ? '' + _NumberOfTimes___get_count__impl__t6j31z($this) + ' times' : 'Infinite times';
  }
  function NumberOfTimes__hashCode_impl_wn8rfw($this) {
    return $this;
  }
  function NumberOfTimes__equals_impl_yhrjns($this, other) {
    if (!(other instanceof NumberOfTimes))
      return false;
    if (!($this === (other instanceof NumberOfTimes ? other.count_1 : THROW_CCE())))
      return false;
    return true;
  }
  ...
  protoOf(NumberOfTimes).toString = function () {
    return NumberOfTimes__toString_impl_gmpdqd(this.count_1);
  };
  protoOf(NumberOfTimes).hashCode = function () {
    return NumberOfTimes__hashCode_impl_wn8rfw(this.count_1);
  };
  protoOf(NumberOfTimes).equals = function (other) {
    return NumberOfTimes__equals_impl_yhrjns(this.count_1, other);
  };
  ...
  function PatternDateFormat(format, locale, tzNames, options) {
    ...
    tzNames = tzNames === VOID ? Companion_getInstance_22().get_DEFAULT_wccqmg_k$() : tzNames;
  ...
  protoOf(PatternDateFormat).get_realLocale_ejo4yp_k$ = function () {
    ...
    return tmp0_elvis_lhs == null ? Companion_getInstance_10().get_default_qtagd4_k$() : tmp0_elvis_lhs;
  };
  ...
  protoOf(PatternDateFormat).get_chunks_bwgbzj_k$ = function () {
    return this.chunks_1;
  };
  protoOf(PatternDateFormat).get_regexChunks_fest5o_k$ = function () {
  ...
  protoOf(PatternDateFormat).get_rx2_18iwn1_k$ = function () {
    return this.rx2__1;
  };
  protoOf(PatternDateFormat).format_tfqdjs_k$ = function (dd) {
    var utc = dd.get_local_g3bngq_k$();
    var out = '';
    var tmp0_iterator = this.chunks_1.iterator_jk1svi_k$();
    while (tmp0_iterator.hasNext_bitz1p_k$()) {
      ...
      switch (name) {
        ...
        case 'MM':
          ...
          break;
        case 'MMM':
          tmp_0 = substr(Companion_getInstance_12().get_c1px32_k$(_DateTime___get_month1__impl__hf8ase(utc)).localName_ietoqh_k$(this.get_realLocale_ejo4yp_k$()), 0, 3);
          break;
        case 'MMMM':
          tmp_0 = Companion_getInstance_12().get_c1px32_k$(_DateTime___get_month1__impl__hf8ase(utc)).localName_ietoqh_k$(this.get_realLocale_ejo4yp_k$());
          break;
        case 'MMMMM':
          tmp_0 = substr(Companion_getInstance_12().get_c1px32_k$(_DateTime___get_month1__impl__hf8ase(utc)).localName_ietoqh_k$(this.get_realLocale_ejo4yp_k$()), 0, 1);
          break;
        case 'y':
  ...
  protoOf(PatternDateFormat).tryParse_hjzgny_k$ = function (str, doThrow, doAdjust) {
    ...
    var result = tmp;
    var tmp1_iterator = zip(this.chunks_1, drop(result.get_groupValues_rkv314_k$(), 1)).iterator_jk1svi_k$();
    $l$loop: while (tmp1_iterator.hasNext_bitz1p_k$()) {
      var tmp2_loop_parameter = tmp1_iterator.next_20eer_k$();
      var name = tmp2_loop_parameter.component1_7eebsc_k$();
      var value = tmp2_loop_parameter.component2_7eebsb_k$();
    ...
    var tmp6_elvis_lhs = offset;
    var tmp_3;
    var tmp_4 = tmp6_elvis_lhs;
  ...
  protoOf(Companion_15).get_DEFAULT_wccqmg_k$ = function () {
    return this.DEFAULT_1;
  };
  protoOf(Companion_15).get_WITH_OPTIONAL_1fkui8_k$ = function () {
    return this.WITH_OPTIONAL_1;
  };
  ...
  function PatternTimeFormat(format, options) {
    ...
    options = options === VOID ? Companion_getInstance_17().DEFAULT_1 : options;
    this.format_1 = format;
    this.options_1 = options;
    this.openOffsets_1 = LinkedHashMap_init_$Create$();
    this.closeOffsets_1 = LinkedHashMap_init_$Create$();
  ...
  protoOf(PatternTimeFormat).get_chunks_bwgbzj_k$ = function () {
    return this.chunks_1;
  };
  ...
  protoOf(PerformanceCounter).get_nanoseconds_3zfxge_k$ = function () {
    return get_nanoseconds_0(KlockInternal_getInstance().get_now_rsuecj_k$());
  };
  protoOf(PerformanceCounter).get_microseconds_sscqkk_k$ = function () {
    return get_microseconds_1(KlockInternal_getInstance().get_now_rsuecj_k$());
  };
  protoOf(PerformanceCounter).get_milliseconds_5yabtn_k$ = function () {
    return get_milliseconds_0(KlockInternal_getInstance().get_now_rsuecj_k$());
  };
  protoOf(PerformanceCounter).get_reference_b526d4_k$ = function () {
  ...
  function Stopwatch_init_$Init$(timeProvider, $this) {
    Stopwatch.call($this, Stopwatch$_init_$lambda_lg3mf2_0(timeProvider));
    return $this;
  }
  function Stopwatch_init_$Create$(timeProvider) {
    return Stopwatch_init_$Init$(timeProvider, objectCreate(protoOf(Stopwatch)));
  }
  function _set_running__3guk6e($this, _set____db54di) {
    $this.running_1 = _set____db54di;
  }
  function _get_running__m5dq6m($this) {
    return $this.running_1;
  }
  function _set_startNano__66n1kh($this, _set____db54di) {
    $this.startNano_1 = _set____db54di;
  }
  function _get_startNano__n47eu3($this) {
    return $this.startNano_1;
  }
  function _get_currentNano__jndyu4($this) {
    return $this.nanosecondProvider_1();
  }
  function setStart($this) {
    $this.startNano_1 = _get_currentNano__jndyu4($this);
  }
  function Stopwatch$_init_$lambda_lg3mf2() {
    return PerformanceCounter_getInstance().get_nanoseconds_3zfxge_k$();
  }
  function Stopwatch$_init_$lambda_lg3mf2_0($timeProvider) {
    return function () {
      // Inline function 'korlibs.time.milliseconds' call
      var this_0 = _DateTime___get_unixMillis__impl__ofxkzp($timeProvider.now_wzdese_k$());
      var tmp$ret$0 = toDuration(this_0, DurationUnit_MILLISECONDS_getInstance());
      return get_nanoseconds_0(tmp$ret$0);
    };
  }
  function Stopwatch(nanosecondProvider) {
    ...
    this.nanosecondProvider_1 = nanosecondProvider;
    this.running_1 = false;
    this.startNano_1 = 0.0;
    setStart(this);
  }
  protoOf(Stopwatch).get_nanosecondProvider_3w9sqq_k$ = function () {
    return this.nanosecondProvider_1;
  };
  protoOf(Stopwatch).start_1tchgi_k$ = function () {
    // Inline function 'kotlin.apply' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'korlibs.time.Stopwatch.start.<anonymous>' call
    setStart(this);
    this.running_1 = true;
    return this;
  };
  protoOf(Stopwatch).restart_i5fdan_k$ = function () {
    return this.start_1tchgi_k$();
  };
  protoOf(Stopwatch).stop_23w8y_k$ = function () {
    // Inline function 'kotlin.apply' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'korlibs.time.Stopwatch.stop.<anonymous>' call
    this.startNano_1 = this.get_elapsedNanoseconds_vlldq0_k$();
    this.running_1 = false;
    return this;
  };
  protoOf(Stopwatch).get_elapsedNanoseconds_vlldq0_k$ = function () {
    return this.running_1 ? _get_currentNano__jndyu4(this) - this.startNano_1 : this.startNano_1;
  };
  protoOf(Stopwatch).get_elapsedMicroseconds_4lbij6_k$ = function () {
    return this.get_elapsedNanoseconds_vlldq0_k$() * 1000;
  };
  protoOf(Stopwatch).get_elapsed_8gymx5_k$ = function () {
    // Inline function 'korlibs.time.nanoseconds' call
    var this_0 = this.get_elapsedNanoseconds_vlldq0_k$();
    return toDuration(this_0, DurationUnit_NANOSECONDS_getInstance());
  };
  protoOf(Stopwatch).getElapsedAndRestart_52r2d0_k$ = function () {
    // Inline function 'kotlin.also' call
    var this_0 = new Duration(this.get_elapsed_8gymx5_k$());
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'korlibs.time.Stopwatch.getElapsedAndRestart.<anonymous>' call
    this_0.rawValue_1;
    this.restart_i5fdan_k$();
  ...
  protoOf(Companion_17).invoke_pdi41e_k$ = function (hour, minute, second, millisecond) {
    // Inline function 'korlibs.time.hours' call
    // Inline function 'korlibs.time.hours' call
  ...
  protoOf(Companion_17).invoke$default_2i9swf_k$ = function (hour, minute, second, millisecond, $super) {
    minute = minute === VOID ? 0 : minute;
    second = second === VOID ? 0 : second;
  ...
  function Time__adjust_impl_1h98gf($this) {
    return Companion_getInstance_19().invoke_pdi41e_k$(_Time___get_hourAdjusted__impl__ubgkp9($this), _Time___get_minute__impl__egf45t($this), _Time___get_second__impl__nhehzj($this), _Time___get_millisecond__impl__qz3nfc($this));
  }
  function Time__format_impl_3nw8zt($this, format) {
    return format_0(Companion_getInstance_20().invoke_lt562m_k$(format), $this);
  }
  ...
  function Companion_18() {
    ...
    this.DEFAULT_FORMAT_1 = Companion_getInstance_20().invoke_lt562m_k$('HH:mm:ss.SSS');
    this.FORMAT_TIME_1 = Companion_getInstance_20().invoke_lt562m_k$('HH:mm:ss');
    this.FORMATS_1 = listOf([this.DEFAULT_FORMAT_1, this.FORMAT_TIME_1]);
  }
  protoOf(Companion_18).get_DEFAULT_FORMAT_t79cy_k$ = function () {
    return this.DEFAULT_FORMAT_1;
  };
  protoOf(Companion_18).get_FORMAT_TIME_32wvqk_k$ = function () {
    return this.FORMAT_TIME_1;
  };
  protoOf(Companion_18).get_FORMATS_1xou37_k$ = function () {
    return this.FORMATS_1;
  };
  protoOf(Companion_18).parse_8aqxct_k$ = function (time) {
    var lastError = null;
    var tmp0_iterator = this.FORMATS_1.iterator_jk1svi_k$();
    while (tmp0_iterator.hasNext_bitz1p_k$()) {
      var format = tmp0_iterator.next_20eer_k$();
  ...
  protoOf(Companion_18).invoke_lt562m_k$ = function (pattern) {
  ...
  function TimeProvider$Companion$invoke$1($callback) {
    this.$callback_1 = $callback;
  }
  protoOf(TimeProvider$Companion$invoke$1).now_wzdese_k$ = function () {
    return this.$callback_1().unixMillis_1;
  };
  function Companion_19() {
    Companion_instance_19 = this;
  }
  protoOf(Companion_19).now_wzdese_k$ = function () {
    return Companion_getInstance_3().now_wzdese_k$();
  };
  protoOf(Companion_19).invoke_qo9hrs_k$ = function (callback) {
    return new TimeProvider$Companion$invoke$1(callback);
  };
  ...
  function get_seconds_1(_this__u8e3s4) {
    _init_properties_TimeSpan_kt__xworpz();
    return get_milliseconds_0(_this__u8e3s4) / get_MILLIS_PER_SECOND();
  }
  function get_milliseconds_2(_this__u8e3s4) {
    _init_properties_TimeSpan_kt__xworpz();
  ...
  function get_microseconds_1(_this__u8e3s4) {
    _init_properties_TimeSpan_kt__xworpz();
    return _Duration___get_inWholeMicroseconds__impl__8oe8vv(_this__u8e3s4).toDouble_ygsx0s_k$();
  }
  function rem(_this__u8e3s4, other) {
    _init_properties_TimeSpan_kt__xworpz();
    // Inline function 'kotlin.time.Companion.milliseconds' call
    Companion_getInstance();
    var this_0 = get_milliseconds_0(_this__u8e3s4) % get_milliseconds_0(other);
    return toDuration(this_0, DurationUnit_MILLISECONDS_getInstance());
  }
  function min(a, b) {
    _init_properties_TimeSpan_kt__xworpz();
    ...
    var a_0 = get_milliseconds_0(a);
    var b_0 = get_milliseconds_0(b);
  ...
  function coalesce(_this__u8e3s4, block) {
    _init_properties_TimeSpan_kt__xworpz();
    return !equals(_this__u8e3s4, get_NIL(Companion_getInstance())) ? _this__u8e3s4 : block().rawValue_1;
  }
  ...
  function roundMilliseconds(_this__u8e3s4) {
    ...
    // Inline function 'kotlin.time.Companion.milliseconds' call
    Companion_getInstance();
    var this_0 = round(get_milliseconds_0(_this__u8e3s4));
    return toDuration(this_0, DurationUnit_MILLISECONDS_getInstance());
  }
  function get_nanoseconds_0(_this__u8e3s4) {
    _init_properties_TimeSpan_kt__xworpz();
    return _Duration___get_inWholeNanoseconds__impl__r5x4mr(_this__u8e3s4).toDouble_ygsx0s_k$();
  }
  function get_nanoseconds_1(_this__u8e3s4) {
    _init_properties_TimeSpan_kt__xworpz();
    return toDuration(_this__u8e3s4, DurationUnit_NANOSECONDS_getInstance());
  }
  function get_microseconds_2(_this__u8e3s4) {
    _init_properties_TimeSpan_kt__xworpz();
    // Inline function 'korlibs.time.microseconds' call
    return toDuration(_this__u8e3s4, DurationUnit_MICROSECONDS_getInstance());
  }
  function get_microsecondsInt(_this__u8e3s4) {
    _init_properties_TimeSpan_kt__xworpz();
    return _Duration___get_inWholeMicroseconds__impl__8oe8vv(_this__u8e3s4).toInt_1tsl84_k$();
  }
  ...
  function get_millisecondsLong(_this__u8e3s4) {
    _init_properties_TimeSpan_kt__xworpz();
    return numberToLong(get_milliseconds_0(_this__u8e3s4));
  }
  ...
  function IntTimedCache(ttl, timeProvider, gen) {
    timeProvider = timeProvider === VOID ? Companion_getInstance_21() : timeProvider;
    this.ttl_1 = ttl;
    this.timeProvider_1 = timeProvider;
    this.gen_1 = gen;
    this.cachedTime_1 = Companion_getInstance_3().get_EPOCH_w1kzk8_k$();
    this._value_1 = 0;
  }
  protoOf(IntTimedCache).get_ttl_ksmf0n_k$ = function () {
    return this.ttl_1;
  };
  protoOf(IntTimedCache).get_timeProvider_64e4ex_k$ = function () {
    return this.timeProvider_1;
  };
  protoOf(IntTimedCache).get_gen_18j57d_k$ = function () {
    return this.gen_1;
  };
  protoOf(IntTimedCache).set_cachedTime_a082u7_k$ = function (_set____db54di) {
    this.cachedTime_1 = _set____db54di;
  };
  protoOf(IntTimedCache).get_cachedTime_l5l7c0_k$ = function () {
    return this.cachedTime_1;
  };
  protoOf(IntTimedCache).set__value_lwvut5_k$ = function (_set____db54di) {
    this._value_1 = _set____db54di;
  };
  protoOf(IntTimedCache).get__value_a7m5q3_k$ = function () {
    return this._value_1;
  };
  protoOf(IntTimedCache).set_value_h293uc_k$ = function (value) {
    this._value_1 = value;
  };
  protoOf(IntTimedCache).get_value_j01efc_k$ = function () {
    // Inline function 'korlibs.time.IntTimedCache.get' call
    var now = this.timeProvider_1.now_wzdese_k$();
    if (equals(this.cachedTime_1, Companion_getInstance_3().get_EPOCH_w1kzk8_k$()) ? true : Duration__compareTo_impl_pchp0f(DateTime__minus_impl_10njw8_2(now, this.cachedTime_1), this.ttl_1) >= 0) {
      this.cachedTime_1 = now;
      this._value_1 = this.gen_1();
    }
    return this._value_1;
  };
  protoOf(IntTimedCache).get_26vq_k$ = function () {
    var now = this.timeProvider_1.now_wzdese_k$();
    if (equals(this.cachedTime_1, Companion_getInstance_3().get_EPOCH_w1kzk8_k$()) ? true : Duration__compareTo_impl_pchp0f(DateTime__minus_impl_10njw8_2(now, this.cachedTime_1), this.ttl_1) >= 0) {
      this.cachedTime_1 = now;
      this._value_1 = this.gen_1();
  ...
  protoOf(IntTimedCache).getValue_fbnwi2_k$ = function (obj, property) {
    // Inline function 'korlibs.time.IntTimedCache.get' call
    var now = this.timeProvider_1.now_wzdese_k$();
    if (equals(this.cachedTime_1, Companion_getInstance_3().get_EPOCH_w1kzk8_k$()) ? true : Duration__compareTo_impl_pchp0f(DateTime__minus_impl_10njw8_2(now, this.cachedTime_1), this.ttl_1) >= 0) {
      this.cachedTime_1 = now;
  ...
  protoOf(Companion_20).get_DEFAULT_wccqmg_k$ = function () {
    return this.DEFAULT_1;
  };
  ...
  protoOf(TimezoneNames).get_6bo4tg_k$ = function (name) {
    ...
    var tmp0_safe_receiver = tmp.get_wei43m_k$(tmp$ret$2);
    return tmp0_safe_receiver == null ? null : first_0(tmp0_safe_receiver);
  };
  ...
  protoOf(TimezoneNames).toString = function () {
    return 'TimezoneNames(timeZones=' + this.timeZones_1 + ')';
  };
  ...
  function _TimezoneOffset___get_totalMinutes__impl__9kqntj($this) {
    return _TimezoneOffset___get_totalMilliseconds__impl__da1mf0($this) / get_MILLIS_PER_MINUTE();
  }
  ...
  protoOf(Companion_21).get_UTC_tvlvnw_k$ = function () {
    return this.UTC_1;
  };
  protoOf(Companion_21).invoke_m9hl7e_k$ = function (time) {
    return _TimezoneOffset___init__impl__4pq59n(get_milliseconds_0(time));
  };
  protoOf(Companion_21).local_qfhv1l_k$ = function (time) {
  ...
  function get_offset(_this__u8e3s4) {
    return Companion_getInstance_23().invoke_m9hl7e_k$(_this__u8e3s4);
  }
  ...
  protoOf(Companion_22).checked_99ekhb_k$ = function (year) {
    // Inline function 'kotlin.apply' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'korlibs.time.Companion.checked.<anonymous>' call
  ...
  protoOf(Companion_22).isLeapChecked_9z5bdp_k$ = function (year) {
    return this.isLeap_iq3syu_k$(this.checked_99ekhb_k$(year));
  };
  protoOf(Companion_22).isLeap_iq3syu_k$ = function (year) {
    return (year % 4 | 0) === 0 ? !((year % 100 | 0) === 0) ? true : (year % 400 | 0) === 0 : false;
  };
  protoOf(Companion_22).fromDays_egwdof_k$ = function (days) {
  ...
  protoOf(Companion_22).days_tlk1ta_k$ = function (isLeap) {
    return isLeap ? 366 : 365;
  };
  protoOf(Companion_22).leapCountSinceOne_ce36nv_k$ = function (year) {
    if (year < 1) {
      var leapCount = 0;
      var y = 1;
      while (y >= year) {
  ...
  protoOf(Companion_22).daysSinceOne_jee0tx_k$ = function (year) {
    return imul(365, year - 1 | 0) + this.leapCountSinceOne_ce36nv_k$(year) | 0;
  };
  protoOf(Companion_22).get_DAYS_COMMON_6j0dii_k$ = function () {
    return this.DAYS_COMMON_1;
  };
  protoOf(Companion_22).get_DAYS_LEAP_b2qgd5_k$ = function () {
  ...
  function _Year___get_isLeapChecked__impl__te7j6c($this) {
    return Companion_getInstance_24().isLeapChecked_9z5bdp_k$(_Year___get_year__impl__hjar94($this));
  }
  function _Year___get_isLeap__impl__kmyeoz($this) {
    return Companion_getInstance_24().isLeap_iq3syu_k$(_Year___get_year__impl__hjar94($this));
  }
  function _Year___get_days__impl__xyqg2q($this) {
    return Companion_getInstance_24().days_tlk1ta_k$(_Year___get_isLeap__impl__kmyeoz($this));
  }
  function _Year___get_leapCountSinceOne__impl__yc28fq($this) {
    return Companion_getInstance_24().leapCountSinceOne_ce36nv_k$(_Year___get_year__impl__hjar94($this));
  }
  function _Year___get_daysSinceOne__impl__cf4kem($this) {
    return Companion_getInstance_24().daysSinceOne_jee0tx_k$(_Year___get_year__impl__hjar94($this));
  }
  ...
  protoOf(Companion_23).invoke_de7zdx_k$ = function (year, month) {
    return Companion_getInstance_25().invoke_w9v7ia_k$(_Year___get_year__impl__hjar94(year), month.get_index1_etpsq0_k$());
  };
  protoOf(Companion_23).invoke_30383o_k$ = function (year, month) {
    return Companion_getInstance_25().invoke_w9v7ia_k$(year, month.get_index1_etpsq0_k$());
  };
  protoOf(Companion_23).invoke_w9v7ia_k$ = function (year, month1) {
  ...
  function _YearMonth___get_month__impl__9q6hh7($this) {
    return Companion_getInstance_12().get_c1px32_k$(_YearMonth___get_month1__impl__5u1az6($this));
  }
  ...
  function YearMonth__plus_impl_mcn3hs($this, span) {
    ...
    return Companion_getInstance_25().invoke_de7zdx_k$(_Year___init__impl__2jvef0((_YearMonth___get_yearInt__impl__2gysi1($this) + get_years(span) | 0) + yearAdjust | 0), Companion_getInstance_12().get_c1px32_k$(newMonth));
  }
  ...
  function YearMonth__toString_impl_v1ol1e($this) {
    return '' + _YearMonth___get_month__impl__9q6hh7($this) + ' ' + _YearMonth___get_yearInt__impl__2gysi1($this);
  }
  ...
  protoOf(MicroStrReader).readChar_vl5a7m_k$ = function () {
    var tmp1 = this.offset_1;
    this.offset_1 = tmp1 + 1 | 0;
    return charSequenceGet(this.str_1, tmp1);
  };
  ...
  function readTimeZoneOffset(_this__u8e3s4, tzNames) {
    ...
    // Inline function 'kotlin.collections.iterator' call
    var tmp0_iterator = tzNames.get_namesToOffsets_qdh52e_k$().get_entries_p20ztl_k$().iterator_jk1svi_k$();
    $l$loop: while (tmp0_iterator.hasNext_bitz1p_k$()) {
      ...
      var offset = tmp1_loop_parameter.get_value_j01efc_k$().rawValue_1;
    ...
    var tmp2_elvis_lhs = toIntOrNull(padStart(substr(part, 0, 2), 2, _Char___init__impl__6a9atx(48)));
    var tmp;
    ...
    var hours = tmp;
    var tmp3_elvis_lhs = toIntOrNull(padStart(substr(part, 2, 2), 2, _Char___init__impl__6a9atx(48)));
    var tmp_0;
  ...
  function get_MILLIS_PER_MINUTE() {
  ...
  _.$_$.b = DateTime__minus_impl_10njw8_2;
  _.$_$.c = DateTime__minus_impl_10njw8_1;
  _.$_$.d = _DateTime___get_unixMillisDouble__impl__3dzlsc;
  _.$_$.e = _Frequency___get_hertz__impl__9m7k6x;
  _.$_$.f = _Frequency___get_timeSpan__impl__f9mrmt;
  _.$_$.g = NumberOfTimes__hashCode_impl_wn8rfw;
  _.$_$.h = Companion_getInstance_2;
  _.$_$.i = Companion_getInstance_3;
  _.$_$.j = Companion_getInstance_14;
  _.$_$.k = PerformanceCounter_getInstance;
  _.$_$.l = Companion_getInstance_21;
  _.$_$.m = DateTime;
  _.$_$.n = IntTimedCache;
  _.$_$.o = get_NIL;
  _.$_$.p = NumberOfTimes;
  ...
  _.$_$.v = get_isNil;
  _.$_$.w = max;
  _.$_$.x = get_microseconds_1;
  _.$_$.y = get_microsecondsInt;
  _.$_$.z = get_milliseconds_0;
  _.$_$.a1 = get_millisecondsLong;
  _.$_$.b1 = min;
  _.$_$.c1 = get_nanoseconds_0;
  _.$_$.d1 = rem;
  _.$_$.e1 = roundMilliseconds;
  _.$_$.f1 = get_seconds_1;
  _.$_$.g1 = toFrequency;
  //endregion
  return _;
}));
