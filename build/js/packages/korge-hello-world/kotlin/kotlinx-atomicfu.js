(function (root, factory) {
  ...
  protoOf(AtomicRef).rh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).sh = function () {
  ...
  protoOf(AtomicBoolean).th = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).sh = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).uh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).sh = function () {
    return this.kotlinx$atomicfu$value;
  };
