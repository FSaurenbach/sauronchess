...
class ChessClockContainer : Container() {
    ...
    private val whiteTimer = Timer(ThemeColors.whiteModeWhite, Game.chessClock!!.whiteTimer)
    private val blackTimer = Timer(ThemeColors.darkModeWhite, Game.chessClock!!.blackTimer)
