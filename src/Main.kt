...
suspend fun main() = Korge(windowSize = Size(DisplayConfig.screenWidth, DisplayConfig.screenHeight), backgroundColor = Colors["#4b3621"]) {
    val sceneContainer = sceneContainer()
    GameState.sCont = sceneContainer
...
class GameScene : Scene() {
    ...
    override suspend fun SContainer.sceneMain() {
        solidRect(DisplayConfig.chessBoardWidth + 18, DisplayConfig.chessBoardHeight + 18, color = ThemeColors.whiteModeBlack).centerOnStage()

        solidRect(DisplayConfig.chessBoardWidth + 10, DisplayConfig.chessBoardHeight + 10, color = ThemeColors.whiteModeWhite).centerOnStage()
        solidRect(DisplayConfig.chessBoardWidth + 1, DisplayConfig.chessBoardHeight + 1, color = Colors.BLACK).centerOnStage()
